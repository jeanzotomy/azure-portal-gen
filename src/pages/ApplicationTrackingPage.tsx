...
export default function ApplicationTrackingPage() {
 ...
 <Input
 id="tid" placeholder="CM-APP000123" value={trackingId}
 onChange={(e) => setTrackingId(e.target.value.toUpperCase())}
 className="mt-1.5 font-mono tracking-wider" required
 />
 </div>
 <div>
 ...
 className="mt-1.5 text-center text-2xl tracking-[0.5em] font-mono h-14" required
 />
 </div>
...
"bg-background text-muted-foreground border-border"}`}>
 ...
 {accepted && (
 <Card className="p-6 bg-primary border-emerald-500/20">
