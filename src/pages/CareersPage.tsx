...
"Découvrez les offres d'emploi CloudMature à Conakry : Cloud, DevOps, IA. Postulez en ligne, sans inscription requise.",
 ...
 <Input
 placeholder="Rechercher par titre, mot-clé, lieu..." value={search}
 onChange={(e) => setSearch(e.target.value)}
 className="pl-9 pr-9 h-11" />
 {search && (
 <button
 type="button" onClick={() => setSearch("")}
 className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground" aria-label="Effacer" >
 <X size={14} />
 </button>
 )}
 </div>
