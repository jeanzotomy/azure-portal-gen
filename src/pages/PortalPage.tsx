...
"Content-Type": file.type ||"application/octet-stream",
 ...
 <CalendarWidget
 mode="single" selected={deadline ? new Date(deadline) : undefined}
...
function TicketsTab({ user }: { user: SupaUser }) {
 ...
 <div className="flex gap-2">
 <Textarea
 placeholder="Écrire une réponse..." value={replyText}
 ...
 className="gradient-primary text-primary-foreground border-0 self-end" size="sm" >
 <Send size={14} />
 </Button>
 </div>
 )}
