...
"id, training_id, completed_at, quiz_score, quiz_passed, course_page, training:trainings(title, description, duration_minutes, category, content)" )
 ...
 <TrainingPageHero
 title="Mes formations" subtitle="Modules continus assignés par votre RH ou administrateur - suivez votre progression et obtenez vos certificats." icon={<GraduationCap className="h-6 w-6 text-white"/>}
 backTo="/portal" breadcrumbs={[
 ...
 className="absolute right-2 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground" aria-label="Effacer la recherche" >
 <X className="h-4 w-4"/>
 </button>
 )}
 </div>
