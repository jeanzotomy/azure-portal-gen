...
export default function VerifyCertificatePage() {
 ...
 return (
 <main className="min-h-screen bg-slate-50/10 px-4 py-10">
 <Helmet>
 ...
 <Row icon={<Calendar className="h-4 w-4 text-primary"/>} label="Délivré le" value={new Date(cert.issued_at).toLocaleDateString("fr-FR", { day:"2-digit", month:"long", year:"numeric"})} />
 {cert.expires_at && (
 <Row icon={<Calendar className="h-4 w-4 text-primary"/>} label="Expire le" value={new Date(cert.expires_at).toLocaleDateString("fr-FR")} />
 )}
