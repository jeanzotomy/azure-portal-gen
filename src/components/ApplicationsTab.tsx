...
export default function ApplicationsTab({ user }: { user: SupaUser }) {
 ...
 <Input
 placeholder="Rechercher par titre d'offre, lieu, département..." value={search}
 ...
 {app.status ==="acceptee"&& (
 <div className="mt-3 p-4 rounded-lg border-2 border-emerald-500/30 bg-emerald-50/10 via-white space-y-3">
 ...
 <Button className="w-full bg-gradient-primary-deep text-primary-foreground hover:opacity-90">
