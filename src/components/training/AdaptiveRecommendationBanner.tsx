...
export function AdaptiveRecommendationBanner({
  ...
  if (!reco) {
    return (
      <Card className="p-3 sm:p-4 border-primary/30 bg-gradient-to-br from-primary/5 via-background to-background">
  ...
  return (
    <Card className="p-4 border-primary/30 bg-gradient-to-br from-primary/5 via-background to-background space-y-3">
