...
export default function SeoTab() {
 ...
 <div className="hidden sm:flex w-11 h-11 rounded-xl bg-primary items-center justify-center shadow-lg shadow-primary/30">
 ...
 <Button
 variant="outline" size="sm" onClick={() => load(false)}
 disabled={loading}
 ...
 />
 <YAxis
 yAxisId="left" tick={{ fontSize: 10, fill:"hsl(var(--muted-foreground))"}}
 tickLine={false}
 axisLine={false}
 />
 <YAxis
 yAxisId="right" orientation="right" tick={{ fontSize: 10, fill:"hsl(var(--muted-foreground))"}}
 tickLine={false}
 axisLine={false}
 />
 <Tooltip
 ...
 {loading
 ?"Chargement…" :"Aucune donnée disponible (GSC met ~2 jours à collecter les premières données après vérification)."}
 </p>
 )}
 </GlassCard>
