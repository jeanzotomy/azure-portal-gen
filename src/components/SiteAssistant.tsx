...
export default function SiteAssistant() {
 ...
 const suggested = locale ==="en" ? ["What services do you offer?","How do you ensure security and quality?","Do you offer trainings?","How can I contact you?"]
 ...
 {/* Bouton flottant */}
 <button
 type="button" aria-label={i18n.open}
...
"ring-4 ring-primary/20 hover:scale-105 transition-transform",
 ...
 {open && (
 <div
 role="dialog" aria-label={i18n.title}
 className={cn(
...
"flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-200",
 ...
 <button
 type="button" aria-label={i18n.close}
...
"max-w-[85%] rounded-2xl px-3 py-2 leading-relaxed",
 ...
 {limitReached ? (
 <div className="border-t border-border bg-primary p-4 space-y-2.5">
 ...
 <Button
 type="button" onClick={goToContact}
 ...
 <Button
 type="submit" size="icon" disabled={!input.trim() || loading}
 className="h-9 w-9 shrink-0 bg-primary" aria-label={i18n.send}
 >
