...
export function ContactSection() {
 ...
 codeSent: locale ==="en" ?"A 6-digit code was sent to your email. Enter it below to confirm." :"Un code à 6 chiffres a été envoyé à votre email. Saisissez-le ci-dessous pour confirmer.",
 ...
 needVerify: locale ==="en" ?"Please verify your email address before sending the message." :"Veuillez d'abord vérifier votre adresse email.",
 cooldown: locale ==="en" ?"Please wait a moment before requesting a new code." :"Merci de patienter quelques instants avant de demander un nouveau code.",
 ...
 {otpLoading && otpStep ==="idle" ? <><Loader2 size={14} className="animate-spin mr-1.5"/>{txt.sending}</>
