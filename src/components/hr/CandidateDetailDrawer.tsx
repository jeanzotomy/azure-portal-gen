...
export default function CandidateDetailDrawer({ applicationId, onOpenChange, onUpdated, onChangeStatus }: Props) {
 ...
 title="Analyse IA" action={
 <Button size="sm"variant="outline"onClick={analyze} disabled={analyzing || app.ai_status ==="processing"}>
 {analyzing || app.ai_status ==="processing" ? <><Loader2 size={13} className="mr-1 animate-spin"/> Analyse…</>
 ...
 <Textarea
 rows={5}
 placeholder="Vos remarques, prochaines étapes, contexte d'entretien..." value={notes}
