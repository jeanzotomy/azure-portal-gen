-- Drop old RPC signature
DROP FUNCTION IF EXISTS public.submit_job_application(uuid, text, text, text, uuid, text, text, text, int, text, text, text);
...
-- Recreate RPC without years_experience / salary_expectation
...
REVOKE ALL ON FUNCTION public.submit_job_application(uuid, text, text, text, uuid, text, text, text, text, text) FROM PUBLIC;
