...
FROM (VALUES
 ('Société Minière de Boké','Mines et sous-traitance minière','Boké','101 à 250',ARRAY['Microsoft 365 E3','Microsoft Azure'],'101 à 250','Dans moins de 30 jours','Oui',ARRAY['Renouveler mes licences','Recevoir un devis','Réduire mes coûts'],'Renouvellement urgent pour 180 postes répartis sur deux sites.','Mamadou Alpha Diallo','Directeur informatique ou DSI','m.diallo@smb-demo.gn','+224 622 11 22 33','Téléphone','Dès que possible',3,100,'urgent','[{"label":"Renouvellement dans moins de 30 jours","points":40},{"label":"Plus de 50 utilisateurs à couvrir","points":20},{"label":"Besoin : Recevoir un devis","points":15},{"label":"Besoin : Renouveler mes licences","points":15},{"label":"Besoin : Réduire mes coûts","points":10}]','nouveau'),
 ...
 ('Kankan BTP','BTP et immobilier','Kankan','26 à 50',ARRAY['Microsoft 365 Business Basic'],'26 à 50','Dans 4 à 6 mois','Je ne sais pas',ARRAY['Réduire mes coûts','Vérifier les licences inutilisées'],'Plusieurs licences semblent inutilisées depuis un an.','Aissatou Barry','Responsable administratif','a.barry@kankanbtp-demo.gn','+224 621 33 44 55','Téléphone','Dans les 48 heures',12,45,'qualifie','[{"label":"Renouvellement dans 4 à 6 mois","points":20},{"label":"Besoin : Réduire mes coûts","points":10},{"label":"Fonction décisionnaire","points":15}]','nouveau'),
